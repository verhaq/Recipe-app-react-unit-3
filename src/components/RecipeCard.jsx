...
const drinkPic= "https://www.archanaskitchen.com/images/archanaskitchen/World_Beverages/Mulled_Apple_Juice_Recipe-1.jpg"
  ...
  return (
    <div className="flex justify-between">
        ...
        <button onClick={handleClick} className="ml-[100px] rounded bg-teal-600 px-3 pb-1 pt-1 text-white ">See More</button>
    ...
    <div  className="relative p-6 bg-white rounded-lg" >
        ...
        <button onClick={handleClick} className="ml-[125px] rounded bg-teal-600 px-3 pb-1 pt-1 text-white ">See More</button>
